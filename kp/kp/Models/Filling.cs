...
namespace kp.Models
{
    public class Filling: DropCreateDatabaseAlways<StudentContext>
    {
        protected override void Seed(StudentContext db)
        {
            //Специальность
            db.Specialtys.Add(new Specialty { SpecialtyId = 1400501, Name_Specialty = "ИСиТ" });
            ...
            //Курс
            db.Courses.Add(new Course { CourseId = 1, Cour = 1, Semester = 1, Group = 2, ID_Specialty = 1400501, ID_Student = 71400001 });
            db.Courses.Add(new Course { CourseId = 2, Cour = 2, Semester = 2, Group = 2, ID_Specialty = 1400501, ID_Student = 71400002 });
            db.Courses.Add(new Course { CourseId = 3, Cour = 3, Semester = 1, Group = 2, ID_Specialty = 1400501, ID_Student = 71400003 });
            db.Courses.Add(new Course { CourseId = 4, Cour = 1, Semester = 2, Group = 2, ID_Specialty = 1400501, ID_Student = 71400004 });
            db.Courses.Add(new Course { CourseId = 5, Cour = 2, Semester = 1, Group = 2, ID_Specialty = 1400501, ID_Student = 71400005 });
            db.Courses.Add(new Course { CourseId = 6, Cour = 3, Semester = 2, Group = 2, ID_Specialty = 1400501, ID_Student = 71400006 });
            db.SaveChanges();
            base.Seed(db);
        }
    }
